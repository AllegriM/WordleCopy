...
function Keyboard() {
    ...
    const handleKeyDown = (e) => {
        const letter = e.key
        console.log(letter.match(/[a-z]/i))
        ...
        <Stack h='auto' w='100%'>
            <Stack maxW='500px' margin='0 auto'>
                <Flex gap='.25em' justifyContent='center'>
                    {
                        keys.slice(0, 9).map((key, index) => {
                            return (
                                <Button key={index} onKeyDown={handleKeyDown} flexGrow='1' variant='solid' h='56px' bg='#d3d6da' opacity='0.8' borderRadius='10px' color='black' align='center' justify='center'>
                ...
                <Flex gap='.25em' justifyContent='center'>
                    ...
                    <Button onKeyDown={handleKeyDown} flexGrow='1' variant='solid' h='56px' w='auto' bg='#d3d6da' opacity='0.8' borderRadius='10px' color='black' align='center' justify='center'>
